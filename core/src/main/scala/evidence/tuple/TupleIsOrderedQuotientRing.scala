...
/**
  * Evidence that tuples of any arity up to 6 form an [[OrderedQuotientRing]]
  ...
  * [[OrderedQuotientRing]] instances.
  */
trait TupleIsOrderedQuotientRing:

  given [X : OrderedQuotientRing as X] => OrderedQuotientRing[X *: EmptyTuple]:
  ...
  given [
    X : OrderedQuotientRing as X,
    Y : OrderedQuotientRing as Y,
  ] => OrderedQuotientRing[(X, Y)]:
  ...
  given [
    X : OrderedQuotientRing as X,
    Y : OrderedQuotientRing as Y,
    Z : OrderedQuotientRing as Z,
  ] => OrderedQuotientRing[(X, Y, Z)]:
  ...
  given [
    X1 : OrderedQuotientRing as X1,
    X2 : OrderedQuotientRing as X2,
    X3 : OrderedQuotientRing as X3,
    X4 : OrderedQuotientRing as X4,
  ] => OrderedQuotientRing[(X1, X2, X3, X4)]:
  ...
  given [
    ...
    X3 : OrderedQuotientRing as X3,
    X4 : OrderedQuotientRing as X4,
    X5 : OrderedQuotientRing as X5,
  ] => OrderedQuotientRing[(X1, X2, X3, X4, X5)]:
  ...
  given [
    ...
    X4 : OrderedQuotientRing as X4,
    X5 : OrderedQuotientRing as X5,
    X6 : OrderedQuotientRing as X6,
  ] => OrderedQuotientRing[(X1, X2, X3, X4, X5, X6)]:
