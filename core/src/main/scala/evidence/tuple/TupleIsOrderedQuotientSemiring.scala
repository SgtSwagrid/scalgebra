...
/**
  ...
  * [[OrderedQuotientSemiring]] under componentwise addition, multiplication,
  * and division and lexicographic ordering, provided all element types have
  * [[OrderedQuotientSemiring]] instances.
  */
trait TupleIsOrderedQuotientSemiring:

  given [X : OrderedQuotientSemiring as X]
    => OrderedQuotientSemiring[X *: EmptyTuple]:
  ...
  given [
    X : OrderedQuotientSemiring as X,
    Y : OrderedQuotientSemiring as Y,
  ] => OrderedQuotientSemiring[(X, Y)]:
  ...
  given [
    X : OrderedQuotientSemiring as X,
    Y : OrderedQuotientSemiring as Y,
    Z : OrderedQuotientSemiring as Z,
  ] => OrderedQuotientSemiring[(X, Y, Z)]:
  ...
  given [
    X1 : OrderedQuotientSemiring as X1,
    X2 : OrderedQuotientSemiring as X2,
    X3 : OrderedQuotientSemiring as X3,
    X4 : OrderedQuotientSemiring as X4,
  ] => OrderedQuotientSemiring[(X1, X2, X3, X4)]:
  ...
  given [
    ...
    X3 : OrderedQuotientSemiring as X3,
    X4 : OrderedQuotientSemiring as X4,
    X5 : OrderedQuotientSemiring as X5,
  ] => OrderedQuotientSemiring[(X1, X2, X3, X4, X5)]:
  ...
  given [
    ...
    X4 : OrderedQuotientSemiring as X4,
    X5 : OrderedQuotientSemiring as X5,
    X6 : OrderedQuotientSemiring as X6,
  ] => OrderedQuotientSemiring[(X1, X2, X3, X4, X5, X6)]:
