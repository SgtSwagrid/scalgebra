...
trait TupleIsOrderedAdditiveMonoid:
  ...
  given [X : OrderedAdditiveMonoid as X]
    => OrderedAdditiveMonoid[X *: EmptyTuple]:
  ...
  ] => OrderedAdditiveMonoid[(X1, X2, X3, X4)]:
  ...
  ] => OrderedAdditiveMonoid[(X1, X2, X3, X4, X5)]:
  ...
  ] => OrderedAdditiveMonoid[(X1, X2, X3, X4, X5, X6)]:
