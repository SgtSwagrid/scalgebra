...
trait TupleIsOrderedDifferenceSemiring:
  ...
  given [X : OrderedDifferenceSemiring as X]
    => OrderedDifferenceSemiring[X *: EmptyTuple]:
  ...
  ] => OrderedDifferenceSemiring[(X, Y, Z)]:
  ...
  ] => OrderedDifferenceSemiring[(X1, X2, X3, X4)]:
  ...
  ] => OrderedDifferenceSemiring[(X1, X2, X3, X4, X5)]:
  ...
  ] => OrderedDifferenceSemiring[(X1, X2, X3, X4, X5, X6)]:
