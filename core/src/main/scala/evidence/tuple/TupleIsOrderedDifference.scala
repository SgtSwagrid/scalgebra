...
trait TupleIsOrderedDifference:
  ...
  given [X : OrderedDifference as X] => OrderedDifference[X *: EmptyTuple]:
  ...
  ] => OrderedDifference[(X1, X2, X3, X4, X5)]:
  ...
  ] => OrderedDifference[(X1, X2, X3, X4, X5, X6)]:
