...
trait TupleIsOrderedAdditiveGroup:
  ...
  given [X : OrderedAdditiveGroup as X]
    => OrderedAdditiveGroup[X *: EmptyTuple]:
  ...
  ] => OrderedAdditiveGroup[(X1, X2, X3, X4)]:
  ...
  ] => OrderedAdditiveGroup[(X1, X2, X3, X4, X5)]:
  ...
  ] => OrderedAdditiveGroup[(X1, X2, X3, X4, X5, X6)]:
