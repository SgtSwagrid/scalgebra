...
trait TupleIsOrderedSemiring:
  ...
  given [X : OrderedSemiring as X] => OrderedSemiring[X *: EmptyTuple]:
  ...
  ] => OrderedSemiring[(X1, X2, X3, X4, X5)]:
  ...
  ] => OrderedSemiring[(X1, X2, X3, X4, X5, X6)]:
