...
/**
  * Evidence that tuples of any arity up to 6 form an [[OrderedPseudoring]]
  * under componentwise negation, addition, and multiplication and lexicographic
  * ordering, provided all element types have [[OrderedPseudoring]] instances.
  */
