...
trait TupleIsOrderedDifferenceMonoid:
  ...
  given [X : OrderedDifferenceMonoid as X]
    => OrderedDifferenceMonoid[X *: EmptyTuple]:
  ...
  ] => OrderedDifferenceMonoid[(X1, X2, X3, X4)]:
  ...
  ] => OrderedDifferenceMonoid[(X1, X2, X3, X4, X5)]:
  ...
  ] => OrderedDifferenceMonoid[(X1, X2, X3, X4, X5, X6)]:
