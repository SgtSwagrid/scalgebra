...
/**
  * Evidence that tuples of any arity up to 6 form a
  * [[QuotientDifferenceSemiring]] under componentwise addition, subtraction,
  * multiplication, and division, provided all element types have
  * [[QuotientDifferenceSemiring]] instances.
  */
trait TupleIsQuotientDifferenceSemiring:

  given [X : QuotientDifferenceSemiring as X]
    => QuotientDifferenceSemiring[X *: EmptyTuple]:
  ...
  given [
    X : QuotientDifferenceSemiring as X,
    Y : QuotientDifferenceSemiring as Y,
  ...
  given [
    X : QuotientDifferenceSemiring as X,
    Y : QuotientDifferenceSemiring as Y,
    Z : QuotientDifferenceSemiring as Z,
  ] => QuotientDifferenceSemiring[(X, Y, Z)]:
  ...
  given [
    X1 : QuotientDifferenceSemiring as X1,
    X2 : QuotientDifferenceSemiring as X2,
    X3 : QuotientDifferenceSemiring as X3,
    X4 : QuotientDifferenceSemiring as X4,
  ] => QuotientDifferenceSemiring[(X1, X2, X3, X4)]:
  ...
  given [
    ...
    X3 : QuotientDifferenceSemiring as X3,
    X4 : QuotientDifferenceSemiring as X4,
    X5 : QuotientDifferenceSemiring as X5,
  ] => QuotientDifferenceSemiring[(X1, X2, X3, X4, X5)]:
  ...
  given [
    ...
    X4 : QuotientDifferenceSemiring as X4,
    X5 : QuotientDifferenceSemiring as X5,
    X6 : QuotientDifferenceSemiring as X6,
  ] => QuotientDifferenceSemiring[(X1, X2, X3, X4, X5, X6)]:
