...
trait TupleIsOrderedAdditiveSemigroup:
  ...
  given [X : OrderedAdditiveSemigroup as X]
    => OrderedAdditiveSemigroup[X *: EmptyTuple]:
  ...
  ] => OrderedAdditiveSemigroup[(X, Y, Z)]:
  ...
  ] => OrderedAdditiveSemigroup[(X1, X2, X3, X4)]:
  ...
  ] => OrderedAdditiveSemigroup[(X1, X2, X3, X4, X5)]:
  ...
  ] => OrderedAdditiveSemigroup[(X1, X2, X3, X4, X5, X6)]:
