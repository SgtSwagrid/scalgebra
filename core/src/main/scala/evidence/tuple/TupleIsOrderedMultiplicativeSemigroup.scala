...
trait TupleIsOrderedMultiplicativeSemigroup:
  ...
  given [X : OrderedMultiplicativeSemigroup as X]
    => OrderedMultiplicativeSemigroup[X *: EmptyTuple]:
  ...
  ] => OrderedMultiplicativeSemigroup[(X, Y)]:
  ...
  ] => OrderedMultiplicativeSemigroup[(X, Y, Z)]:
  ...
  ] => OrderedMultiplicativeSemigroup[(X1, X2, X3, X4)]:
  ...
  ] => OrderedMultiplicativeSemigroup[(X1, X2, X3, X4, X5)]:
  ...
  ] => OrderedMultiplicativeSemigroup[(X1, X2, X3, X4, X5, X6)]:
